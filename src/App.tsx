...
import PierreTrainingProgramPage from "./pages/PierreTrainingProgramPage";
            ...
            <TooltipProvider>
              ...
              <BrowserRouter>
                ...
                <Routes>
                  ...
                  <Route path="/athlete/pierre-gasly/training/:programId" element={<PierreTrainingProgramPage />} />
