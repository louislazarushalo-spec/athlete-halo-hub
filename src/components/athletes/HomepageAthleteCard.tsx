    ...
    >
      <article className="glass-card overflow-hidden transition-all duration-500 hover:border-primary/30 hover:shadow-glow-soft hover:scale-[1.02] active:scale-[0.98]">
        ...
        <div className="relative aspect-[3/4] overflow-hidden">
          ...
          {/* Premium badge for custom athletes - hidden when hideAccessLabels is true */}
          {!hideAccessLabels && isCustomAthlete && (
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6">
            ...
            {/* Access level indicators - hidden when hideAccessLabels is true */}
            {!hideAccessLabels && (
